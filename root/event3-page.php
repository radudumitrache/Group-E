...
<?php
        ...
        try{
          ...
          $stmt = $dbHandler -> prepare("SELECT events_school.events_photo, events_school.events_date, events_school.events_description FROM events_school ORDER BY eventID DESC LIMIT 2,1");
          $stmt->execute();
