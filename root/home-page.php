  ...
  <main>
    ...
    <div id="InfoBanner">
        <a href="event1-page.php">
          <div class="InfoBox">
            <img src="img/homePage/InfoBox1.png" alt="Event1">
            <p>Study affects imagination</p>
          </div>
          <h2 class="overlay">Read more</h2>
        </a>
        <a href="event2-page.php">
          <div class="InfoBox">
            <img src="img/homePage/InfoBox2.png" alt="Event2">
        ...
        <a href="event3-page.php">
          <div class="InfoBox">
            <img src="img/homePage/InfoBox3.png" alt="Event3">
            <p>Creativity</p>
          </div>
          <h2 class="overlay">Read more</h2>
        </a>
