...
<?php
        ...
        try{
          $stmt = $conn -> prepare("SELECT events_school.photo, events_school.event_date, events_school.event_description FROM events_school WHERE eventID = 2 ORDER BY eventID DESC LIMIT 0,1");
          $stmt->execute();
